...
(function initMinicpmI18n(root) {
  ...
  const EN_STRINGS = {
    ...
    onboardingModelLede: "Install MiniCPM5",
    onboardingPreset1BName: "MiniCPM5-1B",
    onboardingPreset1BDesc: "Fast & lightweight (~1.15 GB), low memory footprint. Perfect for laptops & iGPUs.",
    onboardingPreset2BName: "MiniCPM5-2B",
    onboardingPreset2BDesc: "Advanced reasoning & coding (~1.56 GB). Recommended for 16GB+ RAM or GPUs.",
    onboardingPresetRecommended: "Recommended",
    onboardingPresetEnhanced: "Enhanced",
    onboardingDownloadCardTitle: "Download online",
    onboardingDownloadCardDesc: "Auto-selects fastest download source based on your network.",
  ...
  const ZH_STRINGS = {
    ...
    onboardingModelLede: "安装 MiniCPM5",
    onboardingPreset1BName: "MiniCPM5-1B",
    onboardingPreset1BDesc: "快速轻巧 (~1.15 GB)，低内存占用，推荐轻薄本及核显设备使用。",
    onboardingPreset2BName: "MiniCPM5-2B",
    onboardingPreset2BDesc: "更强逻辑与编程能力 (~1.56 GB)，推荐 16GB+ 内存或独立显卡设备。",
    onboardingPresetRecommended: "推荐",
    onboardingPresetEnhanced: "强化",
    onboardingDownloadCardTitle: "在线下载",
    onboardingDownloadCardDesc: "根据你的网络情况自动选择最快下载源。",
  ...
  const ZH_TW_STRINGS = {
    ...
    onboardingModelLede: "安裝 MiniCPM5",
    onboardingPreset1BName: "MiniCPM5-1B",
    onboardingPreset1BDesc: "快速輕巧 (~1.15 GB)，低記憶體佔用，推薦筆記型電腦及內顯設備使用。",
    onboardingPreset2BName: "MiniCPM5-2B",
    onboardingPreset2BDesc: "更強邏輯與編程能力 (~1.56 GB)，推薦 16GB+ 記憶體或獨立顯卡設備。",
    onboardingPresetRecommended: "推薦",
    onboardingPresetEnhanced: "強化",
    onboardingDownloadCardTitle: "線上下載",
    onboardingDownloadCardDesc: "根據你的網路狀況自動選擇最快下載來源。",
  ...
  const KO_STRINGS = {
    ...
    onboardingModelLede: "MiniCPM5 설치",
    onboardingPreset1BName: "MiniCPM5-1B",
    onboardingPreset1BDesc: "빠르고 가벼움 (~1.15 GB), 적은 메모리 사용. 노트북 및 내장 그래픽 기기에 권장.",
    onboardingPreset2BName: "MiniCPM5-2B",
    onboardingPreset2BDesc: "향상된 논리 및 코딩 능력 (~1.56 GB). 16GB+ RAM 또는 외장 GPU 기기에 권장.",
    onboardingPresetRecommended: "추천",
    onboardingPresetEnhanced: "향상",
    onboardingDownloadCardTitle: "온라인 다운로드",
    onboardingDownloadCardDesc: "네트워크 환경에 맞춰 가장 빠른 다운로드 소스를 자동 선택합니다.",
  ...
  const JA_STRINGS = {
    ...
    onboardingModelLede: "MiniCPM5 をインストール",
    onboardingPreset1BName: "MiniCPM5-1B",
    onboardingPreset1BDesc: "高速＆軽量 (~1.15 GB)、低メモリ消費。ノートPCや内蔵GPUに推奨。",
    onboardingPreset2BName: "MiniCPM5-2B",
    onboardingPreset2BDesc: "高度な推論＆コーディング (~1.56 GB)。16GB以上のメモリや独立GPU推奨。",
    onboardingPresetRecommended: "推奨",
    onboardingPresetEnhanced: "強化",
    onboardingDownloadCardTitle: "オンラインダウンロード",
    onboardingDownloadCardDesc: "ネットワーク状況に応じて最速のダウンロード元を自動選択します。",
    onboardingDownloadProgressInit: "準備中...",
