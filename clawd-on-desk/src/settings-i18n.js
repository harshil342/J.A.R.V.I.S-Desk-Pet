...
(function initSettingsI18n(root) {
  const STRINGS = {
    en: {
      ...
      settingsSubtitle: "Configure how Deskpet Assistant behaves on your desktop.",
      ...
      telegramApprovalRecipientHintHtml: "Open [@userinfobot](https://t.me/userinfobot) in Telegram and send /start to get your numeric id. Deskpet Assistant uses it both as the allowed approver and as the chat to send approval cards. Send /start to your own bot at least once first.",
      ...
      telegramApprovalDirectSendDesc: "When you reply to a Deskpet Assistant completion notification, focus the matching local terminal and paste one line. It does not send Enter.",
      ...
      remoteSshSubtitle: "Manage one-click SSH tunnels for remote AI coding sessions. Profiles never store passwords or passphrases — Deskpet Assistant relies on your existing ssh-agent / SSH keys.",
      ...
      remoteSshErrNoLocalPort: "Local Deskpet Assistant server is not yet running.",
      remoteSshErrUnknownStrikes: "Multiple unrecognized errors in a row — please check the profile and logs.",
      remoteSshProbeLocalUnhealthy: "Tunnel established but local Deskpet Assistant server is not healthy.",
      remoteSshProbeUnresponsive: "Tunnel established but Deskpet Assistant is not responding. Make sure Deskpet Assistant is running.",
      ...
      remoteSshConnectWarnNoDeploy: "Hooks are not deployed yet. Connect alone only builds the SSH tunnel — Deskpet Assistant will not react to remote sessions until you click Deploy / Repair Hooks.",
      ...
      doctorTitle: "Deskpet Assistant Doctor",
      ...
      doctorPrivacy: "Privacy notice: this report is generated locally. Deskpet Assistant does not upload data. User paths and secrets are redacted before copying.",
      ...
      doctorFixConfirmCodex: "Deskpet Assistant will set [features].hooks = true in your Codex config. Continue?",
      doctorFixConfirmCodexTitle: "Enable Codex hooks?",
      doctorFixConfirmCodexDetail: "This repair will change your Codex config and set [features].hooks = true. Deskpet Assistant will not make that change unless you confirm it here.",
      doctorFixConfirmCodexAction: "Enable and repair",
      doctorFixConfirmCancel: "Cancel",
      doctorRestartButton: "Restart Deskpet Assistant",
      doctorRestarting: "Restarting",
      doctorRestartConfirmTitle: "Restart Deskpet Assistant?",
      doctorRestartConfirmDetail: "Deskpet Assistant will close and reopen. In-flight requests from your AI coding agents will be dropped. The Doctor window will close as part of the restart.",
      ...
      doctorConnectionNoActivityHint: "No agent hook traffic reached Deskpet Assistant during the test. If you haven't enabled an agent yet, enable or install one in Settings, then send a message from that agent and run the test again.",
      ...
      shortcutLabelToggleChat: "Toggle Deskpet Chat",
      ...
      hardwareBuddyQuickCommandsDesc: "Expose local preset buttons that create adapter-owned quick_command events. Deskpet Assistant does not paste text or run shell commands.",
      ...
      hardwareBuddyTestErr_internal_error: "Hardware Buddy test failed inside Deskpet Assistant.",
      ...
      agentIntegrationUninstallConfirm: "Uninstall this Deskpet Assistant-managed integration? Only Deskpet Assistant-managed hooks, plugins, or extensions will be removed.",
      ...
      agentInstallHintDesc: "Detected local signals for {agents}. Connect them to Deskpet Assistant by installing Deskpet Assistant-managed hooks, plugins, or extensions.",
      ...
      agentCleanupHintDesc: "Deskpet Assistant is connected to {agents}, but no matching local installation was detected. Remove the Deskpet Assistant-managed integration to stop startup sync and event entry for those agents.",
      agentCleanupHintRemove: "Remove integrations",
      agentCleanupHintDismiss: "Keep for now",
      rowAgentPermissions: "Show pop-up bubbles",
      rowAgentPermissionsDesc: "Turn off to let this agent handle prompts in its own terminal instead of showing a Deskpet Assistant bubble.",
      ...
      rowCodexPermissionModeDesc: "Native keeps Codex AutoReview and terminal prompts in charge. Intercept shows Deskpet Assistant Allow/Deny bubbles.",
      ...
      rowSoundDesc: "Play a chime when Deskpet Assistant finishes a task or asks for input.",
      rowVolume: "Volume",
      rowVolumeDesc: "Adjust sound effect volume. Disabled when sound effects are off.",
      rowLowPowerIdleMode: "Low power idle",
      rowLowPowerIdleModeDesc: "Pause idle SVG animation after Deskpet Assistant has been still for a few seconds; activity resumes animation immediately.",
      ...
      rowSessionCleanupGroupDesc: "How long Deskpet Assistant waits before clearing inactive sessions. Mainly affects remote SSH sessions where the terminal isn't visible — raise the limit for long-running remote work, or set Session timeout to 0 to never clear by time.",
      ...
      rowOpenAtLoginDesc: "Start Deskpet Assistant automatically when you log in.",
      ...
      claudeHooksDisconnectConfirmDetail: "This removes Deskpet Assistant-managed Claude hooks from ~/.claude/settings.json and turns off automatic management. Start with Claude Code will be kept for later re-enable.",
      ...
      rowStartWithClaudeDesc: "Auto-launch Deskpet Assistant whenever a Claude Code session starts.",
      ...
      rowHideBubblesDesc: "Hide permission, notification, and update bubbles across Deskpet Assistant.",
      rowBubbleFollow: "Bubbles follow Deskpet Assistant",
      ...
      autoApproveAllConfirmDetail: "Every permission request from every agent will be approved automatically, including running shell commands and deleting files. Deskpet Assistant will not ask you first. Only enable this if you fully trust what your agents are doing.",
      ...
      updateBubbleDisableConfirmDetail: "You may miss update failures, download-complete messages, and restart prompts. The update flow itself will still run, but Deskpet Assistant will not show update bubbles.",
      ...
      rowDisableMiniModeDesc: "Prevent Deskpet Assistant from entering mini mode from edge snap or the menu",
      rowFreeRoam: "Free roam",
      rowFreeRoamDesc: "Let Deskpet Assistant wander freely around the desk when idle. Movement stops when you move the mouse.",
      ...
      placeholderDesc: "This panel will land in a future Deskpet Assistant release. The plan lives in docs/plans/plan-settings-panel.md.",
      ...
      langJapanese: "日本語",
      themeTitle: "Theme",
      themeSubtitle: "Pick a theme for Deskpet Assistant. Cards show built-in + capability badges so you can see tracked/static/mini differences before switching.",
      ...
      themeImportUserThemeZip: "Import Deskpet Assistant theme package (.zip)",
      themeImportUserThemeZipHint: "Deskpet Assistant theme zip: root or one top-level folder must contain theme.json. Put SVG, GIF, APNG, PNG, WebP, JPG, or JPEG assets in assets/. Use Codex Pet import for Codex Pet packages.",
      ...
      toastCodexPetsRefreshOk: (imported, updated, unchanged, removed, invalid, switched) =>
        `Codex Pets refreshed: ${imported} new, ${updated} updated, ${unchanged} unchanged, ${removed} removed${invalid ? `, ${invalid} invalid` : ""}${switched ? "; active theme reset to Deskpet Assistant" : ""}.`,
      ...
      toastCodexPetRemoveOk: (name, switched) => `Uninstalled "${name}"${switched ? " and switched back to Deskpet Assistant" : ""}.`,
      toastCodexPetRemoveFailed: (message) => `Couldn't uninstall imported pet: ${message}`,
      animMapTitle: "Animation Map",
      animMapSubtitle: "Silence individual interrupt animations. Events still fire — Deskpet Assistant just skips the visual and sound for the selected states.",
      ...
      aboutTitle: "About Deskpet Assistant",
      aboutSubtitle: "An on-device AI desktop companion & J.A.R.V.I.S. for your coding workflow.",
      aboutTagline: "A local-first AI companion & J.A.R.V.I.S. for your developer workflow.",
      ...
      aboutFooter: "Deskpet Assistant is open source.",
      aboutCleanupButton: "Remove Deskpet Assistant integrations…",
      aboutCleanupConfirm: "Remove Deskpet Assistant hooks/plugins from local agents and mark all agent integrations as uninstalled and disabled in Deskpet Assistant? This does not delete agent apps or user configs.",
      ...
      assistantSectionTitle: "Assistant",
      assistantSectionDesc: "Personalize how your desk assistant talks and looks.",
      assistantAccentLabel: "Accent color",
      assistantAccentDesc: "Used for highlights in chat bubbles and assistant surfaces.",
      assistantAccentCyan: "Cyan",
      assistantAccentViolet: "Violet",
      assistantAccentAmber: "Amber",
      assistantAccentGreen: "Green",
      assistantAccentCustom: "Custom color",
      assistantOpacityLabel: "Bubble opacity",
      assistantOpacityDesc: "Lower values let more of your desktop show through the bubbles.",
      assistantBlurLabel: "Bubble blur",
      assistantBlurDesc: "Background blur behind chat bubbles, in pixels.",
      assistantTextSizeLabel: "Bubble text size",
      assistantDensityLabel: "Bubble density",
      assistantDensityComfortable: "Comfortable",
      assistantDensityCompact: "Compact",
      assistantTypewriterLabel: "Typewriter effect",
      assistantTypewriterDesc: "Reveal replies character by character instead of all at once.",
      assistantAddressLabel: "What the assistant calls you",
      assistantAddressDesc: "The nickname the assistant uses for you in conversation.",
      assistantAddressPlaceholder: "sir",
      assistantBriefingHourLabel: "Morning briefing hour",
      assistantBriefingHourDesc: "Hour of the day (0–23) when the assistant delivers your daily briefing.",
      assistantRecapHourLabel: "Evening recap hour",
      assistantRecapHourDesc: "Hour of the day (0–23) when the assistant recaps the day with you.",
      assistantChimeLabel: "Reminder chime",
      assistantChimeDesc: "Play a soft chime when a reminder fires.",
      assistantAutoMemoryLabel: "Auto memory",
      assistantAutoMemoryDesc: "Let the assistant remember useful details across chats on its own.",
      assistantClarifyLabel: "Asking for confirmation",
      assistantClarifyOff: "Off",
      assistantClarifyAskWhenAmbiguous: "Ask when ambiguous",
      assistantClarifyConfirmEveryAction: "Confirm every action",
      assistantIdleSleepLabel: "Idle sleep",
      assistantIdleSleepDesc: "How long to stay awake after the last activity before dozing off.",
    },
    zh: {
      settingsTitle: "设置",
      settingsSubtitle: "配置 Deskpet Assistant 在桌面上的行为。",
      sidebarGeneral: "通用",
      ...
      telegramApprovalRecipientHintHtml: "去 Telegram 找 [@userinfobot](https://t.me/userinfobot) 私聊 /start 拿到你的数字 ID。Deskpet Assistant 会用它既作为唯一可审批者，也作为接收审批卡的 chat。记得先去你自己的机器人发一条 /start 激活私聊。",
      ...
      telegramApprovalDirectSendDesc: "回复 Deskpet Assistant 完成通知时，聚焦对应的本地终端并粘贴单行文本。不会按 Enter。",
      ...
      remoteSshSubtitle: "管理一键 SSH 隧道，让远程 AI 编码会话像本地一样工作。Deskpet Assistant 不存任何密码或私钥口令——依赖你已配置的 ssh-agent / SSH 密钥。",
      ...
      remoteSshErrNoLocalPort: "本地 Deskpet Assistant 服务尚未启动。",
      remoteSshErrUnknownStrikes: "连续多次未识别错误，请检查配置和日志。",
      remoteSshProbeLocalUnhealthy: "隧道已建立但本地 Deskpet Assistant 服务异常。",
      remoteSshProbeUnresponsive: "隧道已建立但 Deskpet Assistant 无响应，请确认 Deskpet Assistant 在运行。",
      ...
      remoteSshConnectWarnNoDeploy: "Hook 文件还没部署。Connect 只建 SSH 隧道，不部署 hook——必须点 Deploy / Repair Hooks 之后 Deskpet Assistant 才会响应远端会话。",
      ...
      doctorPrivacy: "隐私说明：诊断报告只在本机生成，Deskpet Assistant 不会上传数据。复制前会脱敏用户路径和密钥。",
      ...
      doctorFixConfirmCodex: "Deskpet Assistant 会把 Codex 配置里的 [features].hooks 设为 true。继续吗？",
      doctorFixConfirmCodexTitle: "启用 Codex hooks？",
      doctorFixConfirmCodexDetail: "这次修复会修改你的 Codex 配置，把 [features].hooks 设为 true。只有你在这里确认后，Deskpet Assistant 才会做这个改动。",
      doctorFixConfirmCodexAction: "启用并修复",
      doctorFixConfirmCancel: "取消",
      doctorRestartButton: "重启 Deskpet Assistant",
      doctorRestarting: "重启中",
      doctorRestartConfirmTitle: "重启 Deskpet Assistant？",
      doctorRestartConfirmDetail: "Deskpet Assistant 会关闭并重新启动。AI coding agent 正在进行的请求会被中断。重启过程中 Doctor 窗口也会一起关闭。",
      ...
      doctorConnectionNoActivityHint: "测试期间没有 agent 的 hook 流量到达 Deskpet Assistant。如果你还没启用 agent，请先在设置里启用或安装一个，然后从该 agent 发一条消息，再重新测试。",
      ...
      shortcutLabelToggleChat: "显示/隐藏 Deskpet Chat",
      ...
      hardwareBuddyQuickCommandsDesc: "显示本地 preset 按钮，只创建由 adapter 处理的 quick_command 事件；Deskpet Assistant 不粘贴文本，也不运行 shell。",
      hardwareBuddyQuickCommandPresets: "Quick Command presets",
      ...
      hardwareBuddyTestErr_internal_error: "Deskpet Assistant 内部执行 Hardware Buddy 测试失败。",
      ...
      agentIntegrationUninstallConfirm: "要卸载这个由 Deskpet Assistant 管理的集成吗？只会移除 Deskpet Assistant 管理的 hooks、插件或扩展。",
      agentIntegrationInstallSkipped: "没有检测到本机安装了 {agents}，所以没有写入集成。",
      agentListSeparator: "、",
      agentInstallHintTitle: "连接检测到的 Agent",
      agentInstallHintDesc: "检测到本机可能有 {agents}。安装由 Deskpet Assistant 管理的 hooks、插件或扩展后，它们就能驱动桌宠。",
      agentInstallHintInstallRecommended: "安装推荐项",
      agentInstallHintDismiss: "暂不处理",
      agentCleanupHintTitle: "检查缺失的本机 Agent",
      agentCleanupHintDesc: "Deskpet Assistant 当前连接了 {agents}，但本机没有检测到对应安装。移除 Deskpet Assistant 管理的集成后，会同时关闭这些 agent 的启动同步和事件入口。",
      agentCleanupHintRemove: "移除集成",
      agentCleanupHintDismiss: "先保留",
      rowAgentPermissions: "显示弹窗",
      rowAgentPermissionsDesc: "关闭后让该 agent 在自己的终端里处理提示，不再弹 Deskpet Assistant 气泡。",
      rowAgentSubagentPermissions: "子 agent 权限弹窗",
      rowAgentSubagentPermissionsDesc: "关闭后，Task 子 agent 发起的权限请求不再弹 Deskpet Assistant 气泡，改回终端处理。",
      rowCodexPermissionMode: "Codex 权限模式",
      rowCodexPermissionModeDesc: "Native 保持 Codex AutoReview 和终端原生提示接管；Intercept 显示 Deskpet Assistant 允许/拒绝气泡。",
      codexPermissionModeNative: "Native",
      codexPermissionModeIntercept: "Intercept",
      ...
      rowSoundDesc: "Deskpet Assistant 完成任务或需要输入时播放提示音。",
      rowVolume: "音量",
      rowVolumeDesc: "调整音效音量。关闭音效时不可用。",
      rowLowPowerIdleMode: "低功耗 idle",
      rowLowPowerIdleModeDesc: "Deskpet Assistant 静止几秒后暂停 idle SVG 动画；有活动时会立即恢复动画。",
      ...
      rowSessionCleanupGroupDesc: "Deskpet Assistant 等待多久才清理不活跃会话。主要影响远程 SSH 会话（看不到终端窗口）——远程长任务可调大；设为 0 则永远不按时间清理。",
      ...
      rowOpenAtLogin: "开机自启",
      rowOpenAtLoginDesc: "登录系统时自动启动 Deskpet Assistant。",
      ...
      claudeHooksDisconnectConfirmDetail: "这会从 `~/.claude/settings.json` 移除 Deskpet Assistant 管理的 Claude hooks，并关闭自动管理。`随 Claude Code 启动` 的偏好会保留，方便以后重新启用。",
      claudeHooksDisconnectConfirmAction: "断开 hooks",
      claudeHooksDisconnectConfirmKeep: "继续保留",
      rowStartWithClaude: "随 Claude Code 启动",
      rowStartWithClaudeDesc: "Claude Code 会话开始时自动拉起 Deskpet Assistant。",
      rowStartWithClaudeDisabledDesc: "需要先开启 Claude hooks 自动管理。关闭期间，端口变化和外部覆盖都不会被自动修补。",
      rowHideBubbles: "隐藏气泡",
      rowHideBubblesDesc: "隐藏 Deskpet Assistant 的权限、通知和更新气泡。",
      rowBubbleFollow: "气泡跟随 Deskpet Assistant",
      ...
      autoApproveAllConfirmDetail: "所有 agent 的每一个权限请求都会被自动通过，包括执行 shell 命令和删除文件。Deskpet Assistant 不会再先问你。只有在你完全信任 agent 的行为时才开启。",
      ...
      updateBubbleDisableConfirmDetail: "隐藏后可能错过更新失败原因、下载完成提示和重启安装提示。更新流程本身仍会继续，但 Deskpet Assistant 不再显示更新气泡。",
      ...
      placeholderDesc: "此面板将在 Deskpet Assistant 后续版本中加入，规划见 docs/plans/plan-settings-panel.md。",
      ...
      langJapanese: "日本語",
      themeTitle: "主题",
      themeSubtitle: "为 Deskpet Assistant 选择一个主题。卡片会显示内建和能力角标，切换前就能看出 tracked / static / mini 等差异。",
      themeEmpty: "没有可用的主题。",
      ...
      themeImportUserThemeZip: "导入 Deskpet Assistant 主题包（.zip）",
      themeImportUserThemeZipHint: "Deskpet Assistant 主题 zip：根目录或一个顶层文件夹内必须包含 theme.json；素材放在 assets/，可使用 SVG、GIF、APNG、PNG、WebP、JPG、JPEG。Codex Pet 包请用上方入口。",
      ...
      toastCodexPetsRefreshOk: (imported, updated, unchanged, removed, invalid, switched) =>
        `Codex Pet 已刷新：新增 ${imported}，更新 ${updated}，未变 ${unchanged}，移除 ${removed}${invalid ? `，无效 ${invalid}` : ""}${switched ? "；当前主题已回退到 Deskpet Assistant" : ""}。`,
      ...
      toastCodexPetRemoveOk: (name, switched) => `已卸载 "${name}"${switched ? "，并切回 Deskpet Assistant" : ""}。`,
      toastCodexPetRemoveFailed: (message) => `卸载导入宠物失败：${message}`,
      animMapTitle: "动画映射",
      animMapSubtitle: "关掉不想看的打扰动画。事件照样会触发——Deskpet Assistant 只是不再播放对应的动画和音效。",
      ...
      aboutTitle: "关于 Deskpet Assistant",
      ...
      aboutFooter: "Deskpet Assistant 为开源软件。",
      aboutCleanupButton: "移除 Deskpet Assistant 集成…",
      aboutCleanupConfirm: "要移除本机各 agent 里的 Deskpet Assistant hooks / plugins，并在 Deskpet Assistant 里把所有 agent 集成标记为未安装且禁用吗？不会删除 agent 应用或用户配置。",
      ...
      assistantSectionTitle: "助手",
      assistantSectionDesc: "自定义桌面助手的说话方式与外观。",
      assistantAccentLabel: "强调色",
      assistantAccentDesc: "用于聊天气泡和助手界面的高亮颜色。",
      assistantAccentCyan: "青色",
      assistantAccentViolet: "紫罗兰",
      assistantAccentAmber: "琥珀色",
      assistantAccentGreen: "绿色",
      assistantAccentCustom: "自定义颜色",
      assistantOpacityLabel: "气泡不透明度",
      assistantOpacityDesc: "数值越低，气泡越能透出后面的桌面。",
      assistantBlurLabel: "气泡背景模糊",
      assistantBlurDesc: "聊天气泡背后的背景模糊程度（像素）。",
      assistantTextSizeLabel: "气泡文字大小",
      assistantDensityLabel: "气泡密度",
      assistantDensityComfortable: "舒适",
      assistantDensityCompact: "紧凑",
      assistantTypewriterLabel: "打字机效果",
      assistantTypewriterDesc: "逐字显示回复，而不是一次性全部出现。",
      assistantAddressLabel: "助手的称呼",
      assistantAddressDesc: "助手在对话中怎么称呼你。",
      assistantAddressPlaceholder: "老板",
      assistantBriefingHourLabel: "晨间简报时间",
      assistantBriefingHourDesc: "每天这个小时（0–23 点）助手会送上当日简报。",
      assistantRecapHourLabel: "晚间回顾时间",
      assistantRecapHourDesc: "每天这个小时（0–23 点）助手会陪你回顾这一天。",
      assistantChimeLabel: "提醒提示音",
      assistantChimeDesc: "触发提醒时播放一声轻柔的提示音。",
      assistantAutoMemoryLabel: "自动记忆",
      assistantAutoMemoryDesc: "允许助手自动记住跨对话的有用细节。",
      assistantClarifyLabel: "操作确认方式",
      assistantClarifyOff: "关闭",
      assistantClarifyAskWhenAmbiguous: "有歧义时追问",
      assistantClarifyConfirmEveryAction: "每个操作都确认",
      assistantIdleSleepLabel: "闲置休眠",
      assistantIdleSleepDesc: "最后一次互动后保持清醒多久才进入休眠。",
    },
    "zh-TW": {
      settingsTitle: "設定",
      settingsSubtitle: "設定 Deskpet Assistant 在桌面上怎麼動作。",
      sidebarGeneral: "一般",
      sidebarAgents: "Agent 管理",
      sidebarTheme: "主題",
      sidebarAnimMap: "動畫對應",
      ...
      telegramApprovalRecipientHintHtml: "到 Telegram 找 [@userinfobot](https://t.me/userinfobot) 私訊 /start 取得你的數字 ID。Deskpet Assistant 會用它同時做為唯一核准者與接收核准卡片的 chat。記得先到你自己的機器人發一次 /start 啟動私訊。",
      telegramApprovalRecipientPlaceholder: "例如：123456789",
      ...
      telegramApprovalDirectSendDesc: "回覆 Deskpet Assistant 完成通知時，聚焦對應的本機終端並貼上單行文字。不會按 Enter。",
      ...
      remoteSshSubtitle: "管理一鍵 SSH 通道，讓遠端 AI 程式設計工作階段像在本機一樣順手。Deskpet Assistant 不會留下任何密碼或私鑰通行片語——靠你已經設好的 ssh-agent 或 SSH 金鑰。",
      ...
      remoteSshErrNoLocalPort: "本機 Deskpet Assistant 服務尚未啟動。",
      remoteSshErrUnknownStrikes: "連續多次無法識別錯誤，請檢查設定和記錄檔。",
      remoteSshProbeLocalUnhealthy: "通道已建立，但本機 Deskpet Assistant 服務狀態異常。",
      remoteSshProbeUnresponsive: "通道已建立，但 Deskpet Assistant 沒有回應，請確認 Deskpet Assistant 是否正在執行。",
      ...
      remoteSshHooksDeployedAgoDay: "{n} 天前部署",
      remoteSshConnectWarnNoDeploy: "Hook 檔案還沒部署。Connect 只接 SSH 通道、不會部署 hook——要先點 Deploy / Repair Hooks，Deskpet Assistant 才會回應遠端工作階段。",
      ...
      doctorPrivacy: "隱私權聲明：診斷報告只在本機產生，Deskpet Assistant 不會上傳任何資料。複製前會自動把使用者路徑和金鑰遮起來。",
      ...
      doctorFixConfirmCodex: "Deskpet Assistant 會把 Codex 設定裡的 [features].hooks 改成 true。要繼續嗎？",
      doctorFixConfirmCodexTitle: "啟用 Codex hooks？",
      doctorFixConfirmCodexDetail: "這次修復會更動你的 Codex 設定，把 [features].hooks 改成 true。除非你在這裡確認，否則 Deskpet Assistant 不會更動。",
      doctorFixConfirmCodexAction: "啟用並修復",
      doctorFixConfirmCancel: "取消",
      doctorRestartButton: "重新啟動 Deskpet Assistant",
      doctorRestarting: "重新啟動中",
      doctorRestartConfirmTitle: "重新啟動 Deskpet Assistant？",
      doctorRestartConfirmDetail: "Deskpet Assistant 會關掉再開起來。AI coding agent 還在跑的請求會被中斷。重新啟動時 Doctor 視窗也會一起關掉。",
      ...
      doctorConnectionNoActivityHint: "測試期間沒有 agent 的 hook 流量到達 Deskpet Assistant。如果你還沒啟用 agent，請先在設定裡啟用或安裝一個，然後從該 agent 發一則訊息，再重新測試。",
      ...
      shortcutLabelToggleChat: "顯示/隱藏 Deskpet Chat",
      ...
      hardwareBuddyQuickCommandsDesc: "顯示本機 preset 按鈕，只建立由 adapter 處理的 quick_command 事件；Deskpet Assistant 不貼上文字，也不執行 shell。",
      hardwareBuddyQuickCommandPresets: "Quick Command presets",
      ...
      agentIntegrationUninstallConfirm: "要解除安裝這個由 Deskpet Assistant 管理的整合嗎？只會移除 Deskpet Assistant 管理的 hooks、外掛或擴充功能。",
      agentIntegrationInstallSkipped: "沒有偵測到本機安裝了 {agents}，所以沒有寫入整合。",
      agentListSeparator: "、",
      agentInstallHintTitle: "連接偵測到的 Agent",
      agentInstallHintDesc: "偵測到本機可能有 {agents}。安裝由 Deskpet Assistant 管理的 hooks、外掛或擴充功能後，它們就能驅動桌寵。",
      agentInstallHintInstallRecommended: "安裝推薦項",
      agentInstallHintDismiss: "暫不處理",
      agentCleanupHintTitle: "檢查缺失的本機 Agent",
      agentCleanupHintDesc: "Deskpet Assistant 目前連接了 {agents}，但本機沒有偵測到對應安裝。移除 Deskpet Assistant 管理的整合後，也會關閉這些 agent 的啟動同步與事件入口。",
      agentCleanupHintRemove: "移除整合",
      agentCleanupHintDismiss: "先保留",
      rowAgentPermissions: "顯示彈出視窗",
      rowAgentPermissionsDesc: "關掉以後，這個 agent 會改由自己的終端機處理提示，不會再彈 Deskpet Assistant 對話框。",
      rowAgentSubagentPermissions: "子 agent 權限彈窗",
      rowAgentSubagentPermissionsDesc: "關掉以後，Task 子 agent 發起的權限請求不會再彈 Deskpet Assistant 對話框，改回終端機處理。",
      rowCodexPermissionMode: "Codex 權限模式",
      rowCodexPermissionModeDesc: "Native 維持 Codex AutoReview 和終端機原本的提示；Intercept 改成顯示 Deskpet Assistant 的允許或拒絕對話框。",
      codexPermissionModeNative: "Native",
      codexPermissionModeIntercept: "Intercept",
      rowCodexNativeNotificationSound: "Native 通知音",
      ...
      rowSoundDesc: "Deskpet Assistant 完成任務或要等輸入時會播放提示聲。",
      rowVolume: "音量",
      rowVolumeDesc: "調整音效音量。停用音效後無法使用。",
      rowLowPowerIdleMode: "低耗電閒置狀態",
      rowLowPowerIdleModeDesc: "Deskpet Assistant 不動幾秒後就暫停閒置狀態 SVG 動畫；有活動時立即恢復。",
      ...
      rowSessionCleanupGroupDesc: "Deskpet Assistant 等多久才清掉沒動靜的工作階段。主要影響遠端 SSH 工作階段（看不到終端機）——遠端長任務可以放寬；設成 0 就完全不按時間清。",
      ...
      rowOpenAtLoginDesc: "登入系統時自動啟動 Deskpet Assistant。",
      ...
      claudeHooksDisconnectConfirmDetail: "這會從 `~/.claude/settings.json` 移除 Deskpet Assistant 管的 Claude hooks，並關掉自動管理。「隨 Claude Code 啟動」的偏好會保留，方便之後再開啟。",
      claudeHooksDisconnectConfirmAction: "中斷 hooks 連線",
      claudeHooksDisconnectConfirmKeep: "繼續保留",
      rowStartWithClaude: "隨 Claude Code 啟動",
      rowStartWithClaudeDesc: "Claude Code 工作階段一開始就自動把 Deskpet Assistant 叫起來。",
      rowStartWithClaudeDisabledDesc: "要先開啟 Claude hooks 自動管理。關掉的時候，連接埠變動和外部更動都不會自動修。",
      rowHideBubbles: "隱藏對話框",
      rowHideBubblesDesc: "隱藏 Deskpet Assistant 的權限、通知和更新對話框。",
      rowBubbleFollow: "對話框跟著 Deskpet Assistant",
      ...
      autoApproveAllConfirmDetail: "所有 agent 的每一個權限請求都會被自動允許，包括執行 shell 命令和刪除檔案。Deskpet Assistant 不會再先問你。只有在你完全信任 agent 的行為時才開啟。",
      ...
      updateBubbleDisableConfirmDetail: "隱藏後可能會錯過更新失敗原因、下載完成提示和重新啟動安裝提示。更新流程本身還是會繼續，只是 Deskpet Assistant 不再顯示更新對話框。",
      ...
      placeholderDesc: "這個面板會在 Deskpet Assistant 後續版本加入，規劃見 docs/plans/plan-settings-panel.md。",
      ...
      langJapanese: "日本語",
      themeTitle: "主題",
      themeSubtitle: "幫 Deskpet Assistant 選擇主題。主題卡會顯示是否為內建主題，以及游標跟隨、靜態、迷你模式等支援項目，方便切換前比較差異。",
      themeEmpty: "沒有主題可以用。",
      ...
      themeImportUserThemeZip: "匯入 Deskpet Assistant 主題套件（.zip）",
      themeImportUserThemeZipHint: "Deskpet Assistant 主題 zip：根目錄或單一頂層資料夾裡要有 theme.json；素材放在 assets/，支援 SVG、GIF、APNG、PNG、WebP、JPG、JPEG。Codex Pet 套件請改用上面的入口。",
      ...
      toastCodexPetsRefreshOk: (imported, updated, unchanged, removed, invalid, switched) =>
        `Codex Pet 已重新整理：新增 ${imported}，更新 ${updated}，沒變 ${unchanged}，移除 ${removed}${invalid ? `，無效 ${invalid}` : ""}${switched ? "；目前主題已切回 Deskpet Assistant" : ""}。`,
      ...
      toastCodexPetRemoveOk: (name, switched) => `已解除安裝「${name}」${switched ? "，並切回 Deskpet Assistant" : ""}。`,
      toastCodexPetRemoveFailed: (message) => `解除安裝匯入的寵物失敗：${message}`,
      animMapTitle: "動畫對應",
      animMapSubtitle: "關掉不想看的打擾動畫。事件還是會觸發——Deskpet Assistant 只是不再播對應的動畫和音效。",
      ...
      aboutTitle: "關於 Deskpet Assistant",
      ...
      aboutFooter: "Deskpet Assistant 為開源軟體。",
      aboutCleanupButton: "移除 Deskpet Assistant 整合…",
      aboutCleanupConfirm: "要移除本機各 agent 內的 Deskpet Assistant hooks / plugins，並在 Deskpet Assistant 中將所有 agent 整合標記為未安裝且停用嗎？不會刪除 agent 應用程式或使用者設定。",
      ...
      assistantSectionTitle: "助理",
      assistantSectionDesc: "自訂桌面助理的說話方式與外觀。",
      assistantAccentLabel: "強調色",
      assistantAccentDesc: "用於聊天對話框和助理介面的強調顏色。",
      assistantAccentCyan: "青色",
      assistantAccentViolet: "紫羅蘭",
      assistantAccentAmber: "琥珀色",
      assistantAccentGreen: "綠色",
      assistantAccentCustom: "自訂顏色",
      assistantOpacityLabel: "對話框不透明度",
      assistantOpacityDesc: "數值越低，對話框越能透出後面的桌面。",
      assistantBlurLabel: "對話框背景模糊",
      assistantBlurDesc: "聊天對話框背後的模糊程度（像素）。",
      assistantTextSizeLabel: "對話框文字大小",
      assistantDensityLabel: "對話框密度",
      assistantDensityComfortable: "舒適",
      assistantDensityCompact: "緊湊",
      assistantTypewriterLabel: "打字機效果",
      assistantTypewriterDesc: "逐字顯示回覆，而不是一次全部出現。",
      assistantAddressLabel: "助理的稱呼",
      assistantAddressDesc: "助理在對話中怎麼稱呼你。",
      assistantAddressPlaceholder: "老闆",
      assistantBriefingHourLabel: "晨間簡報時間",
      assistantBriefingHourDesc: "每天這個小時（0–23 點）助理會送上當日簡報。",
      assistantRecapHourLabel: "晚間回顧時間",
      assistantRecapHourDesc: "每天這個小時（0–23 點）助理會陪你回顧這一天。",
      assistantChimeLabel: "提醒提示音",
      assistantChimeDesc: "觸發提醒時播放一聲輕柔的提示音。",
      assistantAutoMemoryLabel: "自動記憶",
      assistantAutoMemoryDesc: "允許助理自動記住跨對話的有用細節。",
      assistantClarifyLabel: "操作確認方式",
      assistantClarifyOff: "關閉",
      assistantClarifyAskWhenAmbiguous: "有歧義時追問",
      assistantClarifyConfirmEveryAction: "每個操作都確認",
      assistantIdleSleepLabel: "閒置休眠",
      assistantIdleSleepDesc: "最後一次互動後保持清醒多久才進入休眠。",
    },
    ko: {
      settingsTitle: "설정",
      settingsSubtitle: "데스크톱에서 Deskpet Assistant의 동작 방식을 설정합니다.",
      sidebarGeneral: "일반",
      sidebarAgents: "에이전트",
      sidebarTheme: "테마",
      ...
      telegramApprovalRecipientHintHtml: "Telegram에서 [@userinfobot](https://t.me/userinfobot)에게 /start를 보내 숫자 ID를 받으세요. Deskpet Assistant는 이 ID를 승인 가능한 유일한 사용자이자 승인 카드 수신 chat으로 사용합니다. 본인의 bot에게도 먼저 /start를 한 번 보내 비공개 채팅을 활성화해야 합니다.",
      ...
      telegramApprovalDirectSend: "Direct Send (paste-only)",
      telegramApprovalDirectSendDesc: "Deskpet Assistant 완료 알림에 답장하면 해당 로컬 터미널을 포커스하고 한 줄 텍스트를 붙여넣습니다. Enter는 누르지 않습니다.",
      ...
      remoteSshSubtitle: "원클릭 SSH 터널을 관리해 원격 AI 코딩 세션을 매끄럽게 사용하세요. Deskpet Assistant는 비밀번호나 패스프레이즈를 저장하지 않으며, 기존 ssh-agent / SSH 키를 사용합니다.",
      ...
      remoteSshErrNoLocalPort: "로컬 Deskpet Assistant 서버가 아직 시작되지 않았습니다.",
      remoteSshErrUnknownStrikes: "인식할 수 없는 오류가 연속 발생했습니다. 프로필과 로그를 확인하세요.",
      remoteSshProbeLocalUnhealthy: "터널은 연결되었지만 로컬 Deskpet Assistant 서버가 비정상입니다.",
      remoteSshProbeUnresponsive: "터널은 연결되었지만 Deskpet Assistant가 응답하지 않습니다. Deskpet Assistant가 실행 중인지 확인하세요.",
      ...
      remoteSshConnectWarnNoDeploy: "Hook 파일이 아직 배포되지 않았습니다. Connect는 SSH 터널만 구축하므로, Deploy / Repair Hooks를 눌러야 원격 세션에 Deskpet Assistant가 반응합니다.",
      ...
      doctorPrivacy: "개인정보 안내: 진단 보고서는 로컬에서 생성됩니다. Deskpet Assistant는 데이터를 업로드하지 않으며 복사 전에 사용자 경로와 비밀값을 가립니다.",
      ...
      doctorFixConfirmCodex: "Deskpet Assistant가 Codex 설정의 [features].hooks를 true로 변경합니다. 계속할까요?",
      doctorFixConfirmCodexTitle: "Codex hooks를 켤까요?",
      doctorFixConfirmCodexDetail: "이 복구는 Codex 설정의 [features].hooks를 true로 변경합니다. 여기에서 확인하기 전에는 Deskpet Assistant가 이 변경을 하지 않습니다.",
      doctorFixConfirmCodexAction: "켜고 복구",
      doctorFixConfirmCancel: "취소",
      doctorRestartButton: "Deskpet Assistant 재시작",
      doctorRestarting: "재시작 중",
      doctorRestartConfirmTitle: "Deskpet Assistant를 재시작할까요?",
      doctorRestartConfirmDetail: "Deskpet Assistant가 종료된 뒤 다시 실행됩니다. 진행 중인 AI 코딩 에이전트 요청은 중단됩니다. 재시작 중에는 Doctor 창도 함께 닫힙니다.",
      ...
      doctorConnectionNoActivityHint: "테스트 중에 에이전트의 hook 트래픽이 Deskpet Assistant에 도달하지 않았습니다. 아직 에이전트를 활성화하지 않았다면 설정에서 활성화하거나 설치한 뒤, 해당 에이전트에서 메시지를 보내고 다시 테스트하세요.",
      ...
      shortcutLabelToggleChat: "Deskpet Chat 전환",
      ...
      hardwareBuddyQuickCommandsDesc: "로컬 preset 버튼을 표시해 adapter가 처리하는 quick_command 이벤트만 만듭니다. Deskpet Assistant는 텍스트를 붙여넣거나 shell을 실행하지 않습니다.",
      hardwareBuddyQuickCommandPresets: "Quick Command presets",
      ...
      agentIntegrationUninstallConfirm: "이 Deskpet Assistant 관리 통합을 제거할까요? Deskpet Assistant가 관리하는 hooks, 플러그인 또는 확장만 제거됩니다.",
      agentIntegrationInstallSkipped: "{agents}의 로컬 설치를 찾지 못해 통합을 쓰지 않았습니다.",
      agentListSeparator: ", ",
      agentInstallHintTitle: "감지된 에이전트 연결",
      agentInstallHintDesc: "{agents}에 대한 로컬 신호를 감지했습니다. Deskpet Assistant 관리 hooks, 플러그인 또는 확장을 설치해 Deskpet Assistant에 연결할 수 있습니다.",
      agentInstallHintInstallRecommended: "추천 항목 설치",
      agentInstallHintDismiss: "나중에",
      agentCleanupHintTitle: "누락된 로컬 에이전트 검토",
      agentCleanupHintDesc: "Deskpet Assistant가 {agents}에 연결되어 있지만 일치하는 로컬 설치를 찾지 못했습니다. Deskpet Assistant 관리 통합을 제거하면 해당 에이전트의 시작 동기화와 이벤트 입력도 꺼집니다.",
      agentCleanupHintRemove: "통합 제거",
      agentCleanupHintDismiss: "지금은 유지",
      rowAgentPermissions: "팝업 말풍선 표시",
      rowAgentPermissionsDesc: "끄면 이 에이전트는 Deskpet Assistant 말풍선 대신 자체 터미널에서 프롬프트를 처리합니다.",
      rowAgentSubagentPermissions: "서브 에이전트 권한 말풍선",
      rowAgentSubagentPermissionsDesc: "끄면 Task 서브 에이전트의 권한 요청은 Deskpet Assistant 말풍선 없이 터미널에서 처리됩니다.",
      rowCodexPermissionMode: "Codex 권한 모드",
      rowCodexPermissionModeDesc: "Native는 Codex AutoReview와 터미널 프롬프트를 그대로 사용합니다. Intercept는 Deskpet Assistant 허용/거부 말풍선을 표시합니다.",
      codexPermissionModeNative: "Native",
      codexPermissionModeIntercept: "Intercept",
      ...
      rowSoundDesc: "Deskpet Assistant가 작업을 마치거나 입력을 요청할 때 알림음을 재생합니다.",
      rowVolume: "볼륨",
      rowVolumeDesc: "효과음 볼륨을 조절합니다. 효과음이 꺼져 있을 때는 비활성화됩니다.",
      rowLowPowerIdleMode: "저전력 idle",
      rowLowPowerIdleModeDesc: "Deskpet Assistant가 몇 초 동안 가만히 있으면 idle SVG 애니메이션을 일시 중지하고, 활동이 있으면 즉시 다시 재생합니다.",
      ...
      rowSessionCleanupGroupDesc: "Deskpet Assistant가 비활성 세션을 얼마나 기다린 뒤 정리할지 설정합니다. 주로 터미널이 보이지 않는 원격 SSH 세션에 적용됩니다 — 장시간 원격 작업은 한도를 늘리거나, 세션 타임아웃을 0으로 두면 시간으로는 정리하지 않습니다.",
      ...
      rowOpenAtLoginDesc: "로그인할 때 Deskpet Assistant를 자동으로 시작합니다.",
      ...
      claudeHooksDisconnectConfirmDetail: "`~/.claude/settings.json`에서 Deskpet Assistant가 관리하는 Claude hooks를 제거하고 자동 관리를 끕니다. `Claude Code와 함께 시작` 설정은 나중에 다시 켤 수 있도록 유지됩니다.",
      ...
      rowStartWithClaudeDesc: "Claude Code 세션이 시작될 때마다 Deskpet Assistant를 자동으로 실행합니다.",
      ...
      rowHideBubblesDesc: "Deskpet Assistant의 권한, 알림, 업데이트 말풍선을 숨깁니다.",
      rowBubbleFollow: "말풍선이 Deskpet Assistant를 따라다님",
      ...
      autoApproveAllConfirmDetail: "셸 명령 실행과 파일 삭제를 포함해 모든 에이전트의 모든 권한 요청이 자동으로 승인됩니다. Deskpet Assistant가 먼저 묻지 않습니다. 에이전트의 동작을 완전히 신뢰할 때만 켜세요.",
      ...
      updateBubbleDisableConfirmDetail: "업데이트 실패 원인, 다운로드 완료 메시지, 재시작 안내를 놓칠 수 있습니다. 업데이트 흐름은 계속 실행되지만 Deskpet Assistant는 업데이트 말풍선을 표시하지 않습니다.",
      ...
      rowFreeRoam: "자유 배회",
      rowFreeRoamDesc: "대기 중에 Deskpet Assistant가 책상 위를 자유롭게 돌아다닙니다. 마우스를 움직이면 멈춥니다.",
      ...
      placeholderDesc: "이 패널은 향후 Deskpet Assistant 릴리스에 추가됩니다. 계획은 docs/plans/plan-settings-panel.md에 있습니다.",
      ...
      langJapanese: "日本語",
      themeTitle: "테마",
      themeSubtitle: "Deskpet Assistant의 테마를 선택합니다. 카드에는 기본 제공/능력 배지가 표시되어 tracked/static/mini 차이를 미리 볼 수 있습니다.",
      ...
      themeImportUserThemeZip: "Deskpet Assistant 테마 패키지 가져오기 (.zip)",
      themeImportUserThemeZipHint: "Deskpet Assistant 테마 zip: 루트 또는 하나의 최상위 폴더에 theme.json이 있어야 합니다. SVG, GIF, APNG, PNG, WebP, JPG, JPEG 파일은 assets/에 넣으세요. Codex Pet 패키지는 위의 가져오기를 사용하세요.",
      ...
      toastCodexPetsRefreshOk: (imported, updated, unchanged, removed, invalid, switched) =>
        `Codex Pet을 새로고침했습니다: 신규 ${imported}, 업데이트 ${updated}, 변경 없음 ${unchanged}, 제거 ${removed}${invalid ? `, 무효 ${invalid}` : ""}${switched ? "; 활성 테마를 Deskpet Assistant로 되돌림" : ""}.`,
      ...
      toastCodexPetRemoveOk: (name, switched) => `"${name}"을(를) 제거했습니다${switched ? " (Deskpet Assistant로 전환됨)" : ""}.`,
      toastCodexPetRemoveFailed: (message) => `가져온 펫을 제거하지 못했습니다: ${message}`,
      animMapTitle: "애니메이션 맵",
      animMapSubtitle: "개별 인터럽트 애니메이션을 끕니다. 이벤트는 계속 발생하지만 Deskpet Assistant는 선택한 상태의 화면과 소리만 건너뜁니다.",
      ...
      aboutTitle: "Deskpet Assistant 정보",
      ...
      aboutFooter: "Deskpet Assistant은 오픈 소스입니다.",
      aboutCleanupButton: "Deskpet Assistant 통합 제거…",
      aboutCleanupConfirm: "로컬 에이전트의 Deskpet Assistant hooks/plugins를 제거하고 Deskpet Assistant의 모든 에이전트 통합을 미설치 및 비활성 상태로 표시할까요? 에이전트 앱이나 사용자 설정은 삭제하지 않습니다.",
      ...
      assistantSectionTitle: "어시스턴트",
      assistantSectionDesc: "데스크 어시스턴트의 말투와 모습을 꾸며 보세요.",
      assistantAccentLabel: "강조 색",
      assistantAccentDesc: "채팅 말풍선과 어시스턴트 화면의 하이라이트에 사용됩니다.",
      assistantAccentCyan: "청록",
      assistantAccentViolet: "바이올렛",
      assistantAccentAmber: "앰버",
      assistantAccentGreen: "초록",
      assistantAccentCustom: "사용자 지정 색",
      assistantOpacityLabel: "말풍선 불투명도",
      assistantOpacityDesc: "값이 낮을수록 뒤의 바탕화면이 더 비쳐 보입니다.",
      assistantBlurLabel: "말풍선 배경 흐림",
      assistantBlurDesc: "채팅 말풍선 뒤 배경을 흐리게 하는 정도(픽셀)입니다.",
      assistantTextSizeLabel: "말풍선 글자 크기",
      assistantDensityLabel: "말풍선 밀도",
      assistantDensityComfortable: "여유롭게",
      assistantDensityCompact: "컴팩트",
      assistantTypewriterLabel: "타이프라이터 효과",
      assistantTypewriterDesc: "답변을 한 번에 모두 보여 주지 않고 한 글자씩 나타냅니다.",
      assistantAddressLabel: "어시스턴트가 부르는 이름",
      assistantAddressDesc: "대화에서 어시스턴트가 당신을 부르는 호칭입니다.",
      assistantAddressPlaceholder: "님",
      assistantBriefingHourLabel: "아침 브리핑 시간",
      assistantBriefingHourDesc: "매일 이 시각(0~23시)에 어시스턴트가 하루 브리핑을 전달합니다.",
      assistantRecapHourLabel: "저녁 리캡 시간",
      assistantRecapHourDesc: "매일 이 시각(0~23시)에 어시스턴트가 하루를 되돌아봅니다.",
      assistantChimeLabel: "알림 차임벨",
      assistantChimeDesc: "알림이 울릴 때 부드러운 차임벨을 재생합니다.",
      assistantAutoMemoryLabel: "자동 기억",
      assistantAutoMemoryDesc: "어시스턴트가 대화 간에 유용한 정보를 스스로 기억하도록 합니다.",
      assistantClarifyLabel: "확인 질문",
      assistantClarifyOff: "끔",
      assistantClarifyAskWhenAmbiguous: "모호할 때 물어보기",
      assistantClarifyConfirmEveryAction: "모든 작업 확인",
      assistantIdleSleepLabel: "유휴 절전",
      assistantIdleSleepDesc: "마지막 활동 후 이 시간만큼 지나면 절전 모드로 전환됩니다.",
    },
    ja: {
      settingsTitle: "設定",
      settingsSubtitle: "Deskpet Assistant のデスクトップでの動作を設定します。",
      sidebarGeneral: "一般",
      ...
      telegramApprovalRecipientHintHtml: "Telegram で [@userinfobot](https://t.me/userinfobot) に /start を送って数値 ID を取得します。Deskpet Assistant はこの ID を唯一の承認者と承認カードを送る chat の両方として使います。事前に自分の bot にも /start を一度送ってプライベートチャットを有効にしてください。",
      ...
      telegramApprovalDirectSendDesc: "Deskpet Assistant の完了通知に返信すると、対応するローカル端末をフォーカスして 1 行のテキストを貼り付けます。Enter は送信しません。",
      ...
      remoteSshSubtitle: "ワンクリック SSH トンネルを管理し、リモートの AI コーディングセッションをローカルのように扱えます。Deskpet Assistant はパスワードやパスフレーズを保存せず、既存の ssh-agent / SSH キーを使います。",
      ...
      remoteSshErrNoLocalPort: "ローカル Deskpet Assistant サーバーがまだ起動していません。",
      remoteSshErrUnknownStrikes: "認識できないエラーが連続して発生しました。プロフィールとログを確認してください。",
      remoteSshProbeLocalUnhealthy: "トンネルは確立しましたがローカル Deskpet Assistant サーバーが異常です。",
      remoteSshProbeUnresponsive: "トンネルは確立しましたが Deskpet Assistant が応答しません。Deskpet Assistant が起動しているか確認してください。",
      ...
      remoteSshConnectWarnNoDeploy: "Hook ファイルがまだデプロイされていません。Connect は SSH トンネルを張るだけなので、Deploy / Repair Hooks を押さないとリモートセッションに Deskpet Assistant が反応しません。",
      ...
      doctorPrivacy: "プライバシー: この診断レポートはローカルで生成されます。Deskpet Assistant はデータをアップロードしません。コピー前にユーザーパスと秘密情報はマスクされます。",
      ...
      doctorFixConfirmCodex: "Deskpet Assistant が Codex 設定の [features].hooks を true にします。続行しますか？",
      doctorFixConfirmCodexTitle: "Codex hooks を有効にしますか？",
      doctorFixConfirmCodexDetail: "この修復は Codex 設定を変更し、[features].hooks を true にします。ここで確認するまで、Deskpet Assistant はこの変更を行いません。",
      doctorFixConfirmCodexAction: "有効化して修復",
      doctorFixConfirmCancel: "キャンセル",
      doctorRestartButton: "Deskpet Assistant を再起動",
      doctorRestarting: "再起動中",
      doctorRestartConfirmTitle: "Deskpet Assistant を再起動しますか？",
      doctorRestartConfirmDetail: "Deskpet Assistant を終了して再起動します。進行中の AI coding agent リクエストは切断されます。再起動中は Doctor ウィンドウも閉じます。",
      ...
      doctorConnectionNoActivityHint: "テスト中にエージェントの hook トラフィックが Deskpet Assistant に届きませんでした。まだエージェントを有効化していない場合は、設定で有効化またはインストールし、そのエージェントからメッセージを送ってから再度テストしてください。",
      ...
      shortcutLabelToggleChat: "Deskpet Chat の切替",
      ...
      hardwareBuddyQuickCommandsDesc: "ローカル preset ボタンを表示し、adapter が処理する quick_command イベントだけを作成します。Deskpet Assistant は貼り付けや shell 実行をしません。",
      hardwareBuddyQuickCommandPresets: "Quick Command presets",
      ...
      agentIntegrationUninstallConfirm: "この Deskpet Assistant 管理の連携をアンインストールしますか？Deskpet Assistant が管理する hooks、プラグイン、または拡張機能だけを削除します。",
      agentIntegrationInstallSkipped: "{agents} のローカルインストールが見つからなかったため、連携は書き込まれませんでした。",
      agentListSeparator: "、",
      agentInstallHintTitle: "検出したエージェントを接続",
      agentInstallHintDesc: "{agents} のローカル信号を検出しました。Deskpet Assistant 管理の hooks、プラグイン、または拡張機能をインストールして Deskpet Assistant に接続できます。",
      agentInstallHintInstallRecommended: "おすすめをインストール",
      agentInstallHintDismiss: "後で",
      agentCleanupHintTitle: "見つからないローカルエージェントを確認",
      agentCleanupHintDesc: "Deskpet Assistant は {agents} に接続されていますが、一致するローカルインストールが検出されませんでした。Deskpet Assistant 管理の連携を削除すると、それらのエージェントの起動時同期とイベント入口もオフになります。",
      agentCleanupHintRemove: "連携を削除",
      agentCleanupHintDismiss: "今は保持",
      rowAgentPermissions: "ポップアップ吹き出しを表示",
      rowAgentPermissionsDesc: "オフにすると、このエージェントは Deskpet Assistant の吹き出しではなく自身のターミナル上でプロンプトを処理します。",
      rowAgentSubagentPermissions: "サブエージェントの権限吹き出し",
      rowAgentSubagentPermissionsDesc: "オフにすると、Task サブエージェントの権限リクエストは Deskpet Assistant の吹き出しを表示せず、ターミナル側で処理されます。",
      rowCodexPermissionMode: "Codex 権限モード",
      rowCodexPermissionModeDesc: "Native は Codex AutoReview とターミナルの標準プロンプトに任せます。Intercept は Deskpet Assistant の許可/拒否吹き出しを表示します。",
      codexPermissionModeNative: "Native",
      codexPermissionModeIntercept: "Intercept",
      rowCodexNativeNotificationSound: "Native 通知音",
      ...
      rowSoundDesc: "Deskpet Assistant がタスクを完了したとき、または入力を求めたときに音を再生します。",
      rowVolume: "音量",
      rowVolumeDesc: "効果音の音量を調整します。効果音オフの時は無効になります。",
      rowLowPowerIdleMode: "省電力アイドル",
      rowLowPowerIdleModeDesc: "数秒間 Deskpet Assistant が静止していたら idle SVG アニメーションを停止し、活動が再開すると即座に復帰します。",
      ...
      rowSessionCleanupGroupDesc: "Deskpet Assistant が非アクティブなセッションを整理するまでの待機時間。主にターミナルが見えないリモート SSH セッションに影響します — 長時間のリモート作業では制限を緩めるか、セッションタイムアウトを 0 にすると時間では整理しません。",
      ...
      rowOpenAtLoginDesc: "ログイン時に Deskpet Assistant を自動起動します。",
      ...
      claudeHooksDisconnectConfirmDetail: "`~/.claude/settings.json` から Deskpet Assistant 管理の Claude hooks を削除し、自動管理をオフにします。`Claude Code と同時に起動` 設定は後で再有効化できるよう保持されます。",
      claudeHooksDisconnectConfirmAction: "hooks を切断",
      claudeHooksDisconnectConfirmKeep: "接続を維持",
      rowStartWithClaude: "Claude Code と同時に起動",
      rowStartWithClaudeDesc: "Claude Code セッションが開始するたびに Deskpet Assistant を自動起動します。",
      rowStartWithClaudeDisabledDesc: "Claude hooks の自動管理が必要です。管理がオフの間はポート変更や設定上書きが自動修復されません。",
      rowHideBubbles: "吹き出しを非表示",
      rowHideBubblesDesc: "Deskpet Assistant の権限・通知・アップデート吹き出しをまとめて非表示にします。",
      rowBubbleFollow: "吹き出しが Deskpet Assistant に追従",
      ...
      autoApproveAllConfirmDetail: "シェルコマンドの実行やファイルの削除を含め、すべてのエージェントのすべての権限リクエストが自動的に承認されます。Deskpet Assistant は事前に確認しません。エージェントの動作を完全に信頼できる場合のみ有効にしてください。",
      ...
      updateBubbleDisableConfirmDetail: "アップデートエラーの原因・ダウンロード完了通知・再起動プロンプトを見逃す可能性があります。アップデート処理自体は継続しますが、Deskpet Assistant は吹き出しを表示しません。",
      ...
      rowFreeRoam: "自由散策",
      rowFreeRoamDesc: "待機中にDeskpet Assistantがデスク上を自由に歩き回ります。マウスを動かすと停止します。",
      ...
      placeholderDesc: "このパネルは Deskpet Assistant の今後のリリースで追加されます。計画は docs/plans/plan-settings-panel.md にあります。",
      ...
      langJapanese: "日本語",
      themeTitle: "テーマ",
      themeSubtitle: "Deskpet Assistant のテーマを選びます。カードには組み込み・能力バッジが表示されるので、tracked / static / mini の違いを切替前に確認できます。",
      ...
      themeImportUserThemeZip: "Deskpet Assistant テーマパッケージをインポート（.zip）",
      themeImportUserThemeZipHint: "Deskpet Assistant テーマ zip: ルートまたは 1 つのトップフォルダに theme.json が必要です。SVG、GIF、APNG、PNG、WebP、JPG、JPEG は assets/ に入れてください。Codex Pet パッケージは上の入口を使います。",
      ...
      toastCodexPetsRefreshOk: (imported, updated, unchanged, removed, invalid, switched) =>
        `Codex Pet を更新しました: 新規 ${imported}、更新 ${updated}、変更なし ${unchanged}、削除 ${removed}${invalid ? `、無効 ${invalid}` : ""}${switched ? "、使用中テーマを Deskpet Assistant に戻しました" : ""}。`,
      ...
      toastCodexPetRemoveOk: (name, switched) => `"${name}" をアンインストールしました${switched ? "。Deskpet Assistant に戻しました" : ""}。`,
      toastCodexPetRemoveFailed: (message) => `インポート済みペットをアンインストールできませんでした: ${message}`,
      animMapTitle: "アニメーションマップ",
      animMapSubtitle: "個別の割り込みアニメーションをオフにできます。イベント自体は発火しますが、Deskpet Assistant は選択した状態の表示と効果音をスキップします。",
      ...
      aboutTitle: "Deskpet Assistant について",
      ...
      aboutFooter: "Deskpet Assistant はオープンソースです。",
      aboutCleanupButton: "Deskpet Assistant 連携を削除…",
      aboutCleanupConfirm: "ローカル agent から Deskpet Assistant hooks/plugins を削除し、Deskpet Assistant のすべての agent 連携を未インストールかつ無効としてマークしますか？agent アプリやユーザー設定は削除しません。",
      ...
      assistantSectionTitle: "アシスタント",
      assistantSectionDesc: "デスクトップアシスタントの口調や見た目をカスタマイズします。",
      assistantAccentLabel: "アクセントカラー",
      assistantAccentDesc: "チャット吹き出しやアシスタント画面のハイライトに使われます。",
      assistantAccentCyan: "シアン",
      assistantAccentViolet: "バイオレット",
      assistantAccentAmber: "アンバー",
      assistantAccentGreen: "グリーン",
      assistantAccentCustom: "カスタムカラー",
      assistantOpacityLabel: "吹き出しの不透明度",
      assistantOpacityDesc: "数値が低いほど、背面のデスクトップが透けて見えます。",
      assistantBlurLabel: "吹き出しのぼかし",
      assistantBlurDesc: "チャット吹き出しの背景ぼかし量（ピクセル）。",
      assistantTextSizeLabel: "吹き出しの文字サイズ",
      assistantDensityLabel: "吹き出しの余白",
      assistantDensityComfortable: "ゆったり",
      assistantDensityCompact: "コンパクト",
      assistantTypewriterLabel: "タイプライター表示",
      assistantTypewriterDesc: "返信を一括ではなく一文字ずつ表示します。",
      assistantAddressLabel: "あなたの呼び方",
      assistantAddressDesc: "会話の中でアシスタントがあなたを呼ぶときの名前です。",
      assistantAddressPlaceholder: "さん",
      assistantBriefingHourLabel: "朝のブリーフィング時間",
      assistantBriefingHourDesc: "毎日この時刻（0〜23時）にその日のブリーフィングを届けます。",
      assistantRecapHourLabel: "夜のふりかえり時間",
      assistantRecapHourDesc: "毎日この時刻（0〜23時）にその日のまとめを届けます。",
      assistantChimeLabel: "リマインダーのチャイム",
      assistantChimeDesc: "リマインダーが鳴るときにソフトなチャイムを再生します。",
      assistantAutoMemoryLabel: "自動メモリー",
      assistantAutoMemoryDesc: "会話をまたいで役立つ情報をアシスタントが自動で記憶します。",
      assistantClarifyLabel: "確認のしかた",
      assistantClarifyOff: "オフ",
      assistantClarifyAskWhenAmbiguous: "曖昧なときだけ確認",
      assistantClarifyConfirmEveryAction: "毎回確認する",
      assistantIdleSleepLabel: "アイドルスリープ",
      assistantIdleSleepDesc: "最後の操作からこの時間が経つとスリープします。",
    },
  };
  ...
  const MINICPM_PRODUCT_STRINGS = {
    en: {
      settingsSubtitle: "Configure how Deskpet Assistant behaves on your desktop.",
      sidebarMinicpm: "Deskpet Assistant",
      langSystem: "System",
      aboutTitle: "About Deskpet Assistant",
      aboutSubtitle: "An on-device AI desktop companion & J.A.R.V.I.S. for your coding workflow.",
      aboutTagline: "A local-first AI companion & J.A.R.V.I.S. for your developer workflow.",
      aboutFooter: "Deskpet Assistant is open source.",
      minicpmTitle: "Deskpet Assistant",
    ...
    zh: {
      settingsSubtitle: "配置 Deskpet 助手在桌面上的行为。",
      sidebarMinicpm: "Deskpet Assistant",
      langSystem: "跟随系统",
      aboutTitle: "关于 Deskpet Assistant",
      aboutSubtitle: "本地 MiniCPM 驱动的 AI 桌宠。",
    ...
    "zh-TW": {
      settingsSubtitle: "設定 Deskpet 助手在桌面上怎麼動作。",
      sidebarMinicpm: "Deskpet Assistant",
      langSystem: "跟隨系統",
      aboutTitle: "關於 Deskpet Assistant",
      aboutSubtitle: "本地 MiniCPM 驅動的 AI 桌寵。",
